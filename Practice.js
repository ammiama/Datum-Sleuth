const myObject = 
{
    ...
    {
      return this.firstproperty + " " + this.secondproperty // keyword "this" representing object myObject.
    }
};
console.log (myObject['firstproperty']); // first way to call object's property.
console.log(myObject.firstproperty); // second way to call object's property.
console.log(typeof myObject.secondproperty);
console.log(myObject.secondproperty);
console.log(myObject.thirdproperty[3])
console.log(myObject.fullproperty);
